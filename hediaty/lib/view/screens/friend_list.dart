            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  title: Text('Friend ID: ${friend['friend_id']}'),
                  trailing: IconButton(
                    icon: const Icon(Icons.delete, color: Colors.red),
                    onPressed: () async {
                      try {
                        await _friendController.deleteFriend(friend['friend_id'], friend['friendship_id']);
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('Friend deleted successfully!')),
                        );
                      } catch (e) {
                  ...
                  subtitle: Text('Friendship ID: ${friend['friendship_id']}'),
                ),
